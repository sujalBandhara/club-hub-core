...
var UserService = (function () {
    function UserService(client) {
        ...
        this.getState = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.get('users/me').then(function (response) {
                        return response.data;
                    })];
            });
        }); };
        this.postSubDocument = function (userId, path, data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.client.post("users/" + userId + "/meta/" + path, data).then(function (response) {
                        return response.data;
                    })];
            });
        }); };
        this.putSubDocument = function (userId, path, data) { return __awaiter(_this, void 0, void 0, function () {
            var postPath;
            return __generator(this, function (_a) {
                postPath = "users/" + userId + "/meta/" + path;
                return [2, this.client.put(postPath, data).then(function (response) {
                        return response.data;
                    })];
            });
        }); };
