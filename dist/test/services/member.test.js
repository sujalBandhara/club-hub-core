...
describe('Member Service', function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            this.timeout(50000);
            describe('should get the members', function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        it('should return 200 with an array of Members', function () {
                            return __awaiter(this, void 0, void 0, function () {
                                var testUrl, login, service, user;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            ...
                                            return [4, service.members.getMemberById(login.user._id.toString())];
                                        case 2:
                                            user = _a.sent();
