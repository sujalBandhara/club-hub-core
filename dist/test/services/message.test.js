    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            describe('should get all messages', function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        it('should return 200 and all messages', function () {
                            return __awaiter(this, void 0, void 0, function () {
                                var testUrl, login, service, request, message;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            ...
                                            return [4, service.messages.getMessages(request)];
                                        case 2:
                                            message = _a.sent();
                                            chai_1.expect(message).to.exist;
                                            chai_1.expect(message.count).to.exist;
                                            chai_1.expect(message.messages).to.exist;
                                            return [2];
                                    }
                                });
                            });
